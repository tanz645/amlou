...
export default function InternalTab() {
  const [internalData, setInternalData] = useState({
    ...
    brandGuidelines: '',
    brandConsistency: '',
    internalBrandAdvocacy: '',
    brandValuesUnderstanding: '',
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="text"
              value={internalData.rolesCovered}
              onChange={(e) => handleInputChange('rolesCovered', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="e.g., Content, Design, SEO, Social, PR"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={internalData.leadership}
              onChange={(e) => handleInputChange('leadership', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="e.g., CMO, Team Leads, Flat, Matrix"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Team Diversity</label>
            <select
              value={internalData.teamDiversity}
              onChange={(e) => handleInputChange('teamDiversity', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="number"
              step="0.01"
              value={internalData.trainingCompletion}
              onChange={(e) => handleInputChange('trainingCompletion', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
              placeholder="0.00"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={internalData.certifications}
              onChange={(e) => handleInputChange('certifications', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
              placeholder="e.g., Google Ads, HubSpot, Meta Blueprint"
            />
          </div>
          <div>
            ...
            <textarea
              rows={2}
              value={internalData.upskillingPlan}
              onChange={(e) => handleInputChange('upskillingPlan', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
              placeholder="Describe ongoing or planned upskilling..."
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              value={internalData.documentedProcesses}
              onChange={(e) => handleInputChange('documentedProcesses', e.target.value)}
          ...
          <div>
            ...
            <select
              value={internalData.processEfficiency}
          ...
          <div>
            ...
            <select
              value={internalData.crossFunctionalCollab}
              onChange={(e) => handleInputChange('crossFunctionalCollab', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
            >
          ...
          <div>
            ...
            <input
              type="text"
              value={internalData.techStack}
              onChange={(e) => handleInputChange('techStack', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
              placeholder="e.g., HubSpot, Asana, Slack, Canva"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              value={internalData.brandGuidelines}
          ...
          <div>
            ...
            <select
              value={internalData.brandConsistency}
          ...
          <div>
            ...
            <select
              value={internalData.internalBrandAdvocacy}
              onChange={(e) => handleInputChange('internalBrandAdvocacy', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
            >
          ...
          <div>
            ...
            <select
              value={internalData.brandValuesUnderstanding}
              onChange={(e) => handleInputChange('brandValuesUnderstanding', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
            >
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              value={internalData.communicationTools}
              onChange={(e) => handleInputChange('communicationTools', e.target.value)}
          ...
          <div>
            ...
            <select
              value={internalData.feedbackLoops}
          ...
          <div>
            ...
            <select
              value={internalData.innovationEncouragement}
              onChange={(e) => handleInputChange('innovationEncouragement', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
            >
          ...
          <div>
            ...
            <select
              value={internalData.teamMorale}
              onChange={(e) => handleInputChange('teamMorale', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
            >
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              rows={3}
              value={internalData.immediateActions}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <textarea
                rows={3}
                value={internalData.shortTermGoals}
                onChange={(e) => handleInputChange('shortTermGoals', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                placeholder="Short-term internal improvement goals..."
              />
            </div>
            <div>
              ...
              <textarea
                rows={3}
                value={internalData.longTermStrategy}
                onChange={(e) => handleInputChange('longTermStrategy', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                placeholder="Long-term vision for internal team and branding..."
              />
            </div>
          </div>
        </div>
