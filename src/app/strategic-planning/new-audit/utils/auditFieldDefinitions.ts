...
export const AUDIT_FIELD_DEFINITIONS: Record<string, AuditTypeDefinition> = {
  ...
  media_buying: {
    ...
    sections: [
      {
        name: 'Overall Marketing Goals',
        fields: [
          { id: 'marketingGoals', label: 'Marketing Goal(s)', type: 'text' },
          { id: 'marketingPlatforms', label: 'Marketing Platform(s)', type: 'text' },
          { id: 'notesGaps', label: 'Notes & Gaps', type: 'textarea' },
        ],
      },
      {
        name: 'Campaign Level Audit',
        fields: [
          { id: 'campaignName', label: 'Campaign Name', type: 'text' },
          { id: 'objectiveSetCorrectly', label: 'Objective Set Correctly?', type: 'select', options: ['Awareness', 'Traffic', 'Conversions', 'Engagement', 'Video Views', 'Lead Generation', 'Sales', 'Other'] },
          { id: 'buyingType', label: 'Buying Type', type: 'select', options: ['Auction', 'Reach & Frequency'] },
          { id: 'budgetAllocationCampaign', label: 'Budget Allocation', type: 'text' },
          { id: 'optimizationStrategy', label: 'Optimization Strategy', type: 'select', options: ['CBO', 'Manual', 'Other'] },
          { id: 'scalingPotential', label: 'Scaling Potential', type: 'select', options: ['High', 'Medium', 'Low', 'None'] },
          { id: 'performanceKPIs', label: 'Performance KPIs (CPM, CTR, CPA, ROAS)', type: 'text' },
          { id: 'dateRange', label: 'Date Range', type: 'text' },
          { id: 'complianceCheck', label: 'Compliance Check', type: 'text' },
          { id: 'notesRecommendationsCampaign', label: 'Notes & Recommendations', type: 'textarea' },
        ],
      },
      {
        name: 'Ad Set Level Audit',
        fields: [
          { id: 'adSetName', label: 'Ad Set Name', type: 'text' },
          { id: 'demographics', label: 'Demographics (Age, Gender, Location)', type: 'text' },
          { id: 'interests', label: 'Interests', type: 'text' },
          { id: 'behaviors', label: 'Behaviors', type: 'text' },
          { id: 'lookalikes', label: 'Lookalikes', type: 'text' },
          { id: 'audienceSize', label: 'Estimated Audience Size', type: 'text' },
          { id: 'audienceOverlap', label: 'Audience Overlap?', type: 'text' },
          { id: 'placements', label: 'Placements', type: 'text' },
          { id: 'budgetType', label: 'Budget Type', type: 'select', options: ['Daily', 'Lifetime', 'Other'] },
          { id: 'budgetAmount', label: 'Budget Amount', type: 'number' },
          { id: 'pacingStrategy', label: 'Pacing Strategy', type: 'select', options: ['Standard', 'Accelerated', 'Other'] },
          { id: 'frequency', label: 'Frequency (Ad Fatigue)', type: 'text' },
          { id: 'performanceKPIs', label: 'Performance KPIs (CPC, CTR, CVR)', type: 'text' },
          { id: 'notesRecommendations', label: 'Notes & Recommendations', type: 'textarea' },
        ],
      },
      {
        name: 'Ad Level Audit',
        fields: [
          { id: 'adNameId', label: 'Ad Name / ID', type: 'text' },
          { id: 'creativeFormat', label: 'Creative Format', type: 'select', options: ['Image', 'Video', 'Carousel', 'Collection', 'Other'] },
          { id: 'hookStrength', label: 'Hook Strength (Scroll Stop)', type: 'select', options: ['Strong', 'Average', 'Weak'] },
          { id: 'creativeRelevance', label: 'Creative Relevance', type: 'text' },
          { id: 'ctaEffectiveness', label: 'CTA Effectiveness', type: 'select', options: ['Excellent', 'Good', 'Average', 'Poor'] },
          { id: 'adCopyCompliance', label: 'Ad Copy Compliance', type: 'select', options: ['Compliant', 'Minor Issues', 'Major Issues', 'Not Checked'] },
          { id: 'destinationUrl', label: 'Destination URL (UTMs)', type: 'text' },
          { id: 'performanceKPIsAd', label: 'Performance KPIs (ER, CTR, ROAS)', type: 'text' },
          { id: 'abTesting', label: 'A/B Testing?', type: 'select', options: ['Yes', 'No', 'Planned', 'Not Applicable'] },
          { id: 'notesRecommendationsAd', label: 'Notes & Recommendations', type: 'textarea' },
        ],
      },
      {
        name: 'Tracking, Attribution & Compliance',
        fields: [
          { id: 'pixelSdkSetup', label: 'Pixel/SDK Setup', type: 'text' },
          { id: 'eventTracking', label: 'Event Tracking', type: 'text' },
          { id: 'utmTracking', label: 'UTM Tracking', type: 'text' },
          { id: 'attributionModel', label: 'Attribution Model', type: 'text' },
          { id: 'adDisapprovals', label: 'Ad Disapprovals', type: 'text' },
          { id: 'policyViolations', label: 'Policy Violations', type: 'text' },
          { id: 'notesRecommendationsTracking', label: 'Notes & Recommendations', type: 'textarea' },
        ],
      },
      {
        name: 'Media Mix & Channel Analysis',
        fields: [
          { id: 'channelBreakdown', label: 'Channel Breakdown (% Spend)', type: 'text' },
          { id: 'budgetDistribution', label: 'Budget Distribution Alignment', type: 'text' },
          { id: 'performanceByChannel', label: 'Performance by Channel (ROI)', type: 'text' },
          { id: 'opportunitiesToReallocate', label: 'Opportunities to Reallocate', type: 'text' },
        ],
      },
      {
        name: 'Waste & Efficiency',
        fields: [
          { id: 'lowPerformingSegments', label: 'Low Performing Segments', type: 'text' },
          { id: 'highFrequencyIssues', label: 'High Frequency Issues', type: 'text' },
          { id: 'underperformingCreatives', label: 'Underperforming Creatives', type: 'text' },
          { id: 'notesActionPoints', label: 'Notes & Action Points', type: 'textarea' },
        ],
      },
      {
        name: 'Summary & Action Plan',
        fields: [
          { id: 'keyStrengths', label: 'Key Strengths', type: 'text' },
          { id: 'keyWeaknesses', label: 'Key Weaknesses', type: 'text' },
          { id: 'topPriorityFixes', label: 'Top Priority Fixes', type: 'text' },
          { id: 'quickWins', label: 'Quick Wins', type: 'text' },
          { id: 'longTermOpportunities', label: 'Long-Term Opportunities', type: 'text' },
          { id: 'ownerDeadline', label: 'Owner & Deadline', type: 'text' },
        ],
      },
    ],
  },
