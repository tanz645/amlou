...
import StrategicPlanningSidebar from '@/components/sidebars/StrategicPlanningSidebar';

const SIDEBAR_WIDTH = 256; // w-64
const SIDEBAR_COLLAPSED_WIDTH = 64; // w-16

export default function StrategicPlanningShell({ children }: { children: React.ReactNode }) {
  const [collapsed, setCollapsed] = useState(false);

  return (
    <div className="nt-dashboard min-h-screen bg-gray-50">
      <div className="flex pt-12">
        <StrategicPlanningSidebar collapsed={collapsed} setCollapsed={setCollapsed} />
        <div
