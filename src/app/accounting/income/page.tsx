...
const data: Row[] = [
  {
    id: "inc-1",
    date: "2025-12-05",
    description: "Retainer — TechStart Inc",
  ...
  },
  {
    id: "inc-2",
    date: "2025-12-12",
    description: "Campaign milestone 2",
    source: "Creative Agency Co.",
    category: "Services",
    account: "4000 · Sales",
    amount: 18_000,
  },
  {
    id: "inc-3",
    date: "2025-11-28",
    description: "Interest earned — operating sweep",
    source: "First National Bank",
    category: "Interest",
    account: "4200 · Interest income",
    amount: 214,
  },
  {
    id: "inc-4",
    date: "2026-01-08",
    description: "Misc income — old equipment sale",
    source: "Internal",
    category: "Other",
    account: "4900 · Other income",
    amount: 1_350,
  },
];

const categories = ["All", "Services", "Interest", "Other"];
    ...
    <div className="min-h-screen">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-2">Recorded revenue and other income</p>
        </div>
        <button
          type="button"
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="search"
              placeholder="Search description, source, account…"
              value={search}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        {filtered.length === 0 && (
          <div className="text-center py-12 text-gray-500 text-sm">No income entries match your filters.</div>
        )}
      </div>
    </div>
  );
